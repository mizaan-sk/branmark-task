...
export default function Hero() {
  return (
    <section className="pt-28 pb-20 md:pt-[8vw] md:pb-[5vw] bg-[#fffdf5] text-[#2b2058] relative overflow-hidden">
      <div className="w-full max-w-full md:max-w-[80vw] mx-auto px-4 md:px-[2vw]">
        <div className="grid grid-cols-1 md:grid-cols-12 md:gap-[3vw] items-center">
          ...
          >
            {/* Main Headline */}
            <h1 className="font-heading text-4xl sm:text-5xl md:text-[3.6vw] font-black text-[#2b2058] tracking-tight leading-[1.15] md:leading-[4vw] mb-6 md:mb-[1.5vw]">
              Combining <span className="text-[#f5b800]">growth</span> and{" "}
              <span className="text-[#f5b800]">creativity</span> for impactful results
            </h1>

            {/* Paragraph Subtext */}
            <p className="text-slate-700 text-base sm:text-lg md:text-[1.1vw] md:leading-[1.6vw] mb-8 md:mb-[2vw] max-w-xl md:max-w-[34vw] font-medium">
            ...
            <a
              href="#lets-talk-Form"
              className="consult-btn inline-flex items-center gap-2.5 md:gap-[0.6vw] px-6 py-2.5 md:px-[1.5vw] md:py-[0.6vw] rounded-[5px] md:rounded-[0.3vw] text-sm sm:text-base md:text-[0.95vw] font-heading font-medium shadow-sm cursor-pointer"
            >

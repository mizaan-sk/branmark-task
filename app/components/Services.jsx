...
export default function Services() {
  ...
  return (
    <section id="expertise" className="py-20 md:py-[5vw] bg-white border-y border-[#E7E1FF]">
      <div className="w-full max-w-full md:max-w-[80vw] mx-auto px-4 md:px-[2vw]">
        ...
        <div className="text-center max-w-3xl md:max-w-[45vw] mx-auto mb-16 md:mb-[3vw]">
          <h2 className="font-heading text-2xl sm:text-3xl md:text-[2.2vw] md:leading-[2.6vw] font-extrabold text-[#480ED8] mb-4 md:mb-[1vw]">
          ...
          {expertiseList.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 md:p-[1.8vw] rounded-2xl md:rounded-[1.2vw] bg-[#F8FAFC] border border-[#E7E1FF] shadow-md hover:shadow-xl hover:border-[#FF5914] transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="w-12 h-12 md:w-[2.8vw] md:h-[2.8vw] rounded-xl md:rounded-[0.7vw] bg-[#E7E1FF] text-[#480ED8] flex items-center justify-center mb-5 md:mb-[1.2vw]">
                    <Icon className="w-6 h-6 md:w-[1.4vw] md:h-[1.4vw]" />
                  </div>
                  <h3 className="font-heading font-bold text-lg md:text-[1.2vw] md:leading-[1.5vw] text-[#480ED8] mb-3 md:mb-[0.8vw]">
                    {item.title}
                  </h3>
                  <p className="text-xs sm:text-sm md:text-[0.85vw] md:leading-[1.3vw] text-[#1E293B]">
                    {item.description}
                  </p>
                </div>
              </motion.div>
